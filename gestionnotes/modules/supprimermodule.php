...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    $rcne=$_POST['rcne'];
    try {
            $requete = $db->prepare("DELETE FROM modules WHERE id='$rcne'");
            $requete->execute();
        }
        catch(PDOException $e) {
...
<center>
    ...
    <tr>
        <th colspan = "4" ><center>Supprimer un module</center></th>
    </tr>
  	<tr>
    ...
    <input type='submit' class="btn btn-danger" value ='Supprimer' onclick="message()"/>
        <script>
            function message() {
              alert("Le module a été supprimé avec succès");
          }
        </script>
    </form>
    <br><br>
    <a href="modules.php"><img src="../modules/Home_font_awesome.svg.png" width="120px"></a>
</center>
